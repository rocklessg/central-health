...
namespace CentralHealth.Infrastructure.Migrations
{
    ...
    public partial class initialDb : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Invoices_FacilityId_InvoiceDate",
                table: "Invoices",
                columns: new[] { "FacilityId", "InvoiceDate" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MedicalServices_ClinicId_Code",
                table: "MedicalServices",
                columns: new[] { "ClinicId", "Code" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Patients_FacilityId_PatientCode",
                table: "Patients",
                columns: new[] { "FacilityId", "PatientCode" },
                unique: true);
